...
#define API_key  "80f8bfe40553d4a8761ae6f3ca31089c"  // Update Your API Key. To get your API Key, please check the link below
...
void loop(){
  ...
  if(widoClient.connected() && millis() - uploadtStamp > 2000){
    ...
    // make a json string for http post
    char httpPackage[60] = "";
    ...
    widoClient.fastrprint(F("16969/sensor/382202/datapoints"));  //Please change your device ID and sensor ID here, after creating
