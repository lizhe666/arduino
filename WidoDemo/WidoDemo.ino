...
void setup(void)
{
  ...
  */
  ...
  //this will show the information of  ipconfig   just like
  /*
  IP Addr: 172.20.10.9
  ...
  */
  ...
  //until now you can do all the network things!
  
//do the function of  ping !!!!
#ifndef CC3000_TINY_DRIVER
  ...
  //show the ip address  use the common formt  just like 202.113.13.188
  cc3000.printIPdotsRev(ip);

  /* Do a quick ping test on cn.bing.com */
  Serial.print(F("\n\rPinging ")); cc3000.printIPdotsRev(ip); Serial.print("...");
  // do the ping action and return success times
